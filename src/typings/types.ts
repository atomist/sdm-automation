...
export interface _IssueFilter {
  AND: _IssueFilter[]; /* AND */
  OR: _IssueFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  number_in: number[]; /* number_in */
  number_not_in: number[]; /* number_not_in */
  ...
  name_in: string[]; /* name_in */
  name_not_in: string[]; /* name_not_in */
  ...
  title_in: string[]; /* title_in */
  title_not_in: string[]; /* title_not_in */
  ...
  body_in: string[]; /* body_in */
  body_not_in: string[]; /* body_not_in */
  ...
  state_in: IssueState[]; /* state_in */
  state_not_in: IssueState[]; /* state_not_in */
  timestamp?: string | null; /* timestamp */
  timestamp_not?: string | null; /* timestamp_not */
  timestamp_in: string[]; /* timestamp_in */
  timestamp_not_in: string[]; /* timestamp_not_in */
  ...
  action_in: string[]; /* action_in */
  action_not_in: string[]; /* action_not_in */
  ...
  createdAt_in: string[]; /* createdAt_in */
  createdAt_not_in: string[]; /* createdAt_not_in */
  ...
  updatedAt_in: string[]; /* updatedAt_in */
  updatedAt_not_in: string[]; /* updatedAt_not_in */
  ...
  closedAt_in: string[]; /* closedAt_in */
  closedAt_not_in: string[]; /* closedAt_not_in */
...
export interface _RepoFilter {
  ...
  owner_in: string[]; /* owner_in */
  owner_not_in: string[]; /* owner_not_in */
  ...
  repoId_in: string[]; /* repoId_in */
  repoId_not_in: string[]; /* repoId_not_in */
  ...
  gitHubId_in: string[]; /* gitHubId_in */
  gitHubId_not_in: string[]; /* gitHubId_not_in */
  ...
  defaultBranch_in: string[]; /* defaultBranch_in */
  defaultBranch_not_in: string[]; /* defaultBranch_not_in */
  ...
  defaultBranch_not_starts_with?: string | null; /* defaultBranch_not_starts_with */
...
export interface _LabelFilter {
  ...
  default_in: string[]; /* default_in */
  default_not_in: string[]; /* default_not_in */
  ...
  color_in: string[]; /* color_in */
  color_not_in: string[]; /* color_not_in */
...
export interface _ChatChannelFilter {
  AND: _ChatChannelFilter[]; /* AND */
  OR: _ChatChannelFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  provider_in: string[]; /* provider_in */
  provider_not_in: string[]; /* provider_not_in */
  ...
  normalizedName_in: string[]; /* normalizedName_in */
  normalizedName_not_in: string[]; /* normalizedName_not_in */
  ...
  normalizedName_not_starts_with?: string | null; /* normalizedName_not_starts_with */
  normalizedName_ends_with?: string | null; /* normalizedName_ends_with */
  normalizedName_not_ends_with?: string | null; /* normalizedName_not_ends_with */
  channelId?: string | null; /* channelId */
  channelId_not?: string | null; /* channelId_not */
  channelId_in: string[]; /* channelId_in */
  channelId_not_in: string[]; /* channelId_not_in */
...
export interface _ChatIdFilter {
  ...
  screenName_in: string[]; /* screenName_in */
  screenName_not_in: string[]; /* screenName_not_in */
  ...
  userId_in: string[]; /* userId_in */
  userId_not_in: string[]; /* userId_not_in */
  ...
  isAtomistBot_in: string[]; /* isAtomistBot_in */
  isAtomistBot_not_in: string[]; /* isAtomistBot_not_in */
  ...
  isAtomistBot_not_starts_with?: string | null; /* isAtomistBot_not_starts_with */
  ...
  isOwner_in: string[]; /* isOwner_in */
  isOwner_not_in: string[]; /* isOwner_not_in */
  ...
  isPrimaryOwner_in: string[]; /* isPrimaryOwner_in */
  isPrimaryOwner_not_in: string[]; /* isPrimaryOwner_not_in */
  ...
  isPrimaryOwner_not_starts_with?: string | null; /* isPrimaryOwner_not_starts_with */
  isPrimaryOwner_ends_with?: string | null; /* isPrimaryOwner_ends_with */
  isPrimaryOwner_not_ends_with?: string | null; /* isPrimaryOwner_not_ends_with */
  isAdmin?: string | null; /* isAdmin */
  isAdmin_not?: string | null; /* isAdmin_not */
  isAdmin_in: string[]; /* isAdmin_in */
  isAdmin_not_in: string[]; /* isAdmin_not_in */
  ...
  isBot_in: string[]; /* isBot_in */
  isBot_not_in: string[]; /* isBot_not_in */
  ...
  timezoneLabel_in: string[]; /* timezoneLabel_in */
  timezoneLabel_not_in: string[]; /* timezoneLabel_not_in */
  ...
  timezoneLabel_not_starts_with?: string | null; /* timezoneLabel_not_starts_with */
...
export interface _EmailFilter {
  ...
  address_in: string[]; /* address_in */
  address_not_in: string[]; /* address_not_in */
...
export interface _SCMIdFilter {
  ...
  login_in: string[]; /* login_in */
  login_not_in: string[]; /* login_not_in */
...
export interface _GitHubProviderFilter {
  AND: _GitHubProviderFilter[]; /* AND */
  OR: _GitHubProviderFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  url_in: string[]; /* url_in */
  url_not_in: string[]; /* url_not_in */
  ...
  providerId_in: string[]; /* providerId_in */
  providerId_not_in: string[]; /* providerId_not_in */
  ...
  apiUrl_in: string[]; /* apiUrl_in */
  apiUrl_not_in: string[]; /* apiUrl_not_in */
  ...
  gitUrl_in: string[]; /* gitUrl_in */
  gitUrl_not_in: string[]; /* gitUrl_not_in */
  ...
  providerType_in: ProviderType[]; /* providerType_in */
  providerType_not_in: ProviderType[]; /* providerType_not_in */
...
export interface _TeamFilter {
  ...
  description_in: string[]; /* description_in */
  description_not_in: string[]; /* description_not_in */
  ...
  iconUrl_in: string[]; /* iconUrl_in */
  iconUrl_not_in: string[]; /* iconUrl_not_in */
...
export interface _PersonFilter {
  ...
  forename_in: string[]; /* forename_in */
  forename_not_in: string[]; /* forename_not_in */
  ...
  surname_in: string[]; /* surname_in */
  surname_not_in: string[]; /* surname_not_in */
...
export interface _GitHubIdFilter {
  AND: _GitHubIdFilter[]; /* AND */
  OR: _GitHubIdFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _SCMProviderFilter {
  AND: _SCMProviderFilter[]; /* AND */
  OR: _SCMProviderFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _OrgFilter {
  ...
  ownerType_in: OwnerType[]; /* ownerType_in */
  ownerType_not_in: OwnerType[]; /* ownerType_not_in */
  provider?: _GitHubProviderFilter | null; /* provider */
  provider_not?: _GitHubProviderFilter | null; /* provider_not */
  provider_in?: _GitHubProviderFilter | null; /* provider_in */
  provider_not_in?: _GitHubProviderFilter | null; /* provider_not_in */
...
export interface _GitHubOrgWebhookFilter {
  AND: _GitHubOrgWebhookFilter[]; /* AND */
  OR: _GitHubOrgWebhookFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  webhookType_in: WebhookType[]; /* webhookType_in */
  webhookType_not_in: WebhookType[]; /* webhookType_not_in */
  org?: _OrgFilter | null; /* org */
  org_not?: _OrgFilter | null; /* org_not */
  org_in?: _OrgFilter | null; /* org_in */
  org_not_in?: _OrgFilter | null; /* org_not_in */
...
export interface _WebhookFilter {
  AND: _WebhookFilter[]; /* AND */
  OR: _WebhookFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _ChatTeamFilter {
  AND: _ChatTeamFilter[]; /* AND */
  OR: _ChatTeamFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  domain_in: string[]; /* domain_in */
  domain_not_in: string[]; /* domain_not_in */
  ...
  messageCount_in: number[]; /* messageCount_in */
  messageCount_not_in: number[]; /* messageCount_not_in */
  ...
  emailDomain_in: string[]; /* emailDomain_in */
  emailDomain_not_in: string[]; /* emailDomain_not_in */
...
export interface _ChannelLinkFilter {
  AND: _ChannelLinkFilter[]; /* AND */
  OR: _ChannelLinkFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _PullRequestFilter {
  AND: _PullRequestFilter[]; /* AND */
  OR: _PullRequestFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  prId_in: string[]; /* prId_in */
  prId_not_in: string[]; /* prId_not_in */
  ...
  state_in: string[]; /* state_in */
  state_not_in: string[]; /* state_not_in */
  ...
  baseBranchName_in: string[]; /* baseBranchName_in */
  baseBranchName_not_in: string[]; /* baseBranchName_not_in */
  ...
  baseBranchName_not_starts_with?: string | null; /* baseBranchName_not_starts_with */
  baseBranchName_ends_with?: string | null; /* baseBranchName_ends_with */
  baseBranchName_not_ends_with?: string | null; /* baseBranchName_not_ends_with */
  branchName?: string | null; /* branchName */
  branchName_not?: string | null; /* branchName_not */
  branchName_in: string[]; /* branchName_in */
  branchName_not_in: string[]; /* branchName_not_in */
  ...
  mergedAt_in: string[]; /* mergedAt_in */
  mergedAt_not_in: string[]; /* mergedAt_not_in */
...
export interface _CommitFilter {
  ...
  sha_in: string[]; /* sha_in */
  sha_not_in: string[]; /* sha_not_in */
  ...
  message_in: string[]; /* message_in */
  message_not_in: string[]; /* message_not_in */
...
export interface _BuildFilter {
  ...
  buildId_in: string[]; /* buildId_in */
  buildId_not_in: string[]; /* buildId_not_in */
  ...
  status_in: BuildStatus[]; /* status_in */
  status_not_in: BuildStatus[]; /* status_not_in */
  buildUrl?: string | null; /* buildUrl */
  buildUrl_not?: string | null; /* buildUrl_not */
  buildUrl_in: string[]; /* buildUrl_in */
  buildUrl_not_in: string[]; /* buildUrl_not_in */
  ...
  compareUrl_in: string[]; /* compareUrl_in */
  compareUrl_not_in: string[]; /* compareUrl_not_in */
  ...
  trigger_in: BuildTrigger[]; /* trigger_in */
  trigger_not_in: BuildTrigger[]; /* trigger_not_in */
  provider?: string | null; /* provider */
  provider_not?: string | null; /* provider_not */
  provider_in: string[]; /* provider_in */
  provider_not_in: string[]; /* provider_not_in */
  ...
  pullRequestNumber_in: number[]; /* pullRequestNumber_in */
  pullRequestNumber_not_in: number[]; /* pullRequestNumber_not_in */
  ...
  startedAt_in: string[]; /* startedAt_in */
  startedAt_not_in: string[]; /* startedAt_not_in */
  ...
  finishedAt_in: string[]; /* finishedAt_in */
  finishedAt_not_in: string[]; /* finishedAt_not_in */
  ...
  workflowId_in: string[]; /* workflowId_in */
  workflowId_not_in: string[]; /* workflowId_not_in */
  ...
  jobName_in: string[]; /* jobName_in */
  jobName_not_in: string[]; /* jobName_not_in */
  ...
  jobId_in: string[]; /* jobId_in */
  jobId_not_in: string[]; /* jobId_not_in */
  ...
  data_not_in: string[]; /* data_not_in */
...
export interface _PushFilter {
  ...
  branch_in: string[]; /* branch_in */
  branch_not_in: string[]; /* branch_not_in */
...
export interface _TagFilter {
  ...
  ref_in: string[]; /* ref_in */
  ref_not_in: string[]; /* ref_not_in */
...
export interface _ReleaseFilter {
  AND: _ReleaseFilter[]; /* AND */
  OR: _ReleaseFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _DockerImageFilter {
  AND: _DockerImageFilter[]; /* AND */
  OR: _DockerImageFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  image_not_in: string[]; /* image_not_in */
  ...
  imageName_in: string[]; /* imageName_in */
  imageName_not_in: string[]; /* imageName_not_in */
...
export interface _K8PodFilter {
  ...
  phase_in: string[]; /* phase_in */
  phase_not_in: string[]; /* phase_not_in */
  ...
  environment_in: string[]; /* environment_in */
  environment_not_in: string[]; /* environment_not_in */
  ...
  baseName_in: string[]; /* baseName_in */
  baseName_not_in: string[]; /* baseName_not_in */
  ...
  namespace_in: string[]; /* namespace_in */
  namespace_not_in: string[]; /* namespace_not_in */
  ...
  statusJSON_in: string[]; /* statusJSON_in */
  statusJSON_not_in: string[]; /* statusJSON_not_in */
  ...
  host_in: string[]; /* host_in */
  host_not_in: string[]; /* host_not_in */
  ...
  specsJSON_in: string[]; /* specsJSON_in */
  specsJSON_not_in: string[]; /* specsJSON_not_in */
  ...
  envJSON_in: string[]; /* envJSON_in */
  envJSON_not_in: string[]; /* envJSON_not_in */
  ...
  metadataJSON_in: string[]; /* metadataJSON_in */
  metadataJSON_not_in: string[]; /* metadataJSON_not_in */
  ...
  metadataJSON_not_starts_with?: string | null; /* metadataJSON_not_starts_with */
  ...
  containersCrashLoopBackOff_not?: boolean | null; /* containersCrashLoopBackOff_not */
  resourceVersion?: number | null; /* resourceVersion */
  resourceVersion_not?: number | null; /* resourceVersion_not */
  resourceVersion_in: number[]; /* resourceVersion_in */
  resourceVersion_not_in: number[]; /* resourceVersion_not_in */
...
export interface _K8ContainerFilter {
  AND: _K8ContainerFilter[]; /* AND */
  OR: _K8ContainerFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  containerJSON_in: string[]; /* containerJSON_in */
  containerJSON_not_in: string[]; /* containerJSON_not_in */
  ...
  containerJSON_not_starts_with?: string | null; /* containerJSON_not_starts_with */
  ...
  stateReason_in: string[]; /* stateReason_in */
  stateReason_not_in: string[]; /* stateReason_not_in */
  ...
  restartCount_in: number[]; /* restartCount_in */
  restartCount_not_in: number[]; /* restartCount_not_in */
  ...
  containerID_in: string[]; /* containerID_in */
  containerID_not_in: string[]; /* containerID_not_in */
...
export interface _WorkflowFilter {
  AND: _WorkflowFilter[]; /* AND */
  OR: _WorkflowFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  config_in: string[]; /* config_in */
  config_not_in: string[]; /* config_not_in */
...
export interface _StatusFilter {
  ...
  state_in: StatusState[]; /* state_in */
  state_not_in: StatusState[]; /* state_not_in */
  description?: string | null; /* description */
  description_not?: string | null; /* description_not */
  description_in: string[]; /* description_in */
  description_not_in: string[]; /* description_not_in */
  ...
  targetUrl_in: string[]; /* targetUrl_in */
  targetUrl_not_in: string[]; /* targetUrl_not_in */
  ...
  context_in: string[]; /* context_in */
  context_not_in: string[]; /* context_not_in */
...
export interface _HerokuAppFilter {
  AND: _HerokuAppFilter[]; /* AND */
  OR: _HerokuAppFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  app_in: string[]; /* app_in */
  app_not_in: string[]; /* app_not_in */
  ...
  user_in: string[]; /* user_in */
  user_not_in: string[]; /* user_not_in */
  ...
  appId_in: string[]; /* appId_in */
  appId_not_in: string[]; /* appId_not_in */
  ...
  release_in: string[]; /* release_in */
  release_not_in: string[]; /* release_not_in */
...
export interface _ApplicationFilter {
  AND: _ApplicationFilter[]; /* AND */
  OR: _ApplicationFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _FingerprintFilter {
  AND: _FingerprintFilter[]; /* AND */
  OR: _FingerprintFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _ParentImpactFilter {
  AND: _ParentImpactFilter[]; /* AND */
  OR: _ParentImpactFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _BranchFilter {
  ...
  remoteRepoHtmlUrl_in: string[]; /* remoteRepoHtmlUrl_in */
  remoteRepoHtmlUrl_not_in: string[]; /* remoteRepoHtmlUrl_not_in */
  ...
  remoteRepoHtmlUrl_not_contains?: string | null; /* remoteRepoHtmlUrl_not_contains */
  remoteRepoHtmlUrl_starts_with?: string | null; /* remoteRepoHtmlUrl_starts_with */
  remoteRepoHtmlUrl_not_starts_with?: string | null; /* remoteRepoHtmlUrl_not_starts_with */
  remoteRepoHtmlUrl_ends_with?: string | null; /* remoteRepoHtmlUrl_ends_with */
  remoteRepoHtmlUrl_not_ends_with?: string | null; /* remoteRepoHtmlUrl_not_ends_with */
  repo?: _RepoFilter | null; /* repo */
  repo_not?: _RepoFilter | null; /* repo_not */
  repo_in?: _RepoFilter | null; /* repo_in */
  repo_not_in?: _RepoFilter | null; /* repo_not_in */
...
export interface _ReviewFilter {
  ...
  reviewId_in: string[]; /* reviewId_in */
  reviewId_not_in: string[]; /* reviewId_not_in */
  ...
  state_in: ReviewState[]; /* state_in */
  state_not_in: ReviewState[]; /* state_not_in */
  submittedAt?: string | null; /* submittedAt */
  submittedAt_not?: string | null; /* submittedAt_not */
  submittedAt_in: string[]; /* submittedAt_in */
  submittedAt_not_in: string[]; /* submittedAt_not_in */
  ...
  htmlUrl_in: string[]; /* htmlUrl_in */
  htmlUrl_not_in: string[]; /* htmlUrl_not_in */
...
export interface _CommentFilter {
  AND: _CommentFilter[]; /* AND */
  OR: _CommentFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
  ...
  commentId_in: string[]; /* commentId_in */
  commentId_not_in: string[]; /* commentId_not_in */
  ...
  path_not_in: string[]; /* path_not_in */
  ...
  position_in: string[]; /* position_in */
  position_not_in: string[]; /* position_not_in */
  ...
  commentType_in: CommentCommentType[]; /* commentType_in */
  commentType_not_in: CommentCommentType[]; /* commentType_not_in */
  issue?: _IssueFilter | null; /* issue */
  issue_not?: _IssueFilter | null; /* issue_not */
  issue_in?: _IssueFilter | null; /* issue_in */
  issue_not_in?: _IssueFilter | null; /* issue_not_in */
...
export interface _DeletedBranchFilter {
  AND: _DeletedBranchFilter[]; /* AND */
  OR: _DeletedBranchFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _ImageLinkedFilter {
  AND: _ImageLinkedFilter[]; /* AND */
  OR: _ImageLinkedFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _PushImpactFilter {
  AND: _PushImpactFilter[]; /* AND */
  OR: _PushImpactFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _PullRequestImpactFilter {
  AND: _PullRequestImpactFilter[]; /* AND */
  OR: _PullRequestImpactFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export interface _UserJoinedChannelFilter {
  AND: _UserJoinedChannelFilter[]; /* AND */
  OR: _UserJoinedChannelFilter[]; /* OR */
  atmTeamId?: string | null; /* atmTeamId */
  atmTeamId_not?: string | null; /* atmTeamId_not */
  atmTeamId_in: string[]; /* atmTeamId_in */
  atmTeamId_not_in: string[]; /* atmTeamId_not_in */
...
export type ProviderType = "bitbucket_cloud" | "github_com" | "ghe" | "bitbucket" | "gitlab";
...
export type _SCMIdOrdering = "atmTeamId_asc" | "atmTeamId_desc" | "login_asc" | "login_desc" | "name_asc" | "name_desc";
...
export type _TeamOrdering = "atmTeamId_asc" | "atmTeamId_desc" | "id_asc" | "id_desc" | "name_asc" | "name_desc" | "description_asc" | "description_desc" | "iconUrl_asc" | "iconUrl_desc" | "createdAt_asc" | "createdAt_desc";
...
export type SdmGoalState = "success" | "requested" | "waiting_for_approval" | "failure" | "planned" | "in_process" | "skipped";
...
export type _BranchOrdering = "atmTeamId_asc" | "atmTeamId_desc" | "id_asc" | "id_desc" | "name_asc" | "name_desc" | "timestamp_asc" | "timestamp_desc" | "isRemote_asc" | "isRemote_desc" | "remoteRepoHtmlUrl_asc" | "remoteRepoHtmlUrl_desc";

/* Ordering Enum for Review */
export type _ReviewOrdering = "atmTeamId_asc" | "atmTeamId_desc" | "id_asc" | "id_desc" | "gitHubId_asc" | "gitHubId_desc" | "reviewId_asc" | "reviewId_desc" | "body_asc" | "body_desc" | "state_asc" | "state_desc" | "submittedAt_asc" | "submittedAt_desc" | "htmlUrl_asc" | "htmlUrl_desc";

/* Ordering Enum for Comment */
export type _CommentOrdering = "atmTeamId_asc" | "atmTeamId_desc" | "id_asc" | "id_desc" | "body_asc" | "body_desc" | "timestamp_asc" | "timestamp_desc" | "createdAt_asc" | "createdAt_desc" | "updatedAt_asc" | "updatedAt_desc" | "commentId_asc" | "commentId_desc" | "gitHubId_asc" | "gitHubId_desc" | "path_asc" | "path_desc" | "position_asc" | "position_desc" | "htmlUrl_asc" | "htmlUrl_desc" | "commentType_asc" | "commentType_desc";
...
export type SdmDeployState = "requested" | "disabled";
...
export namespace SdmGoalSetBadge {
  ...
  export type Query = {
    SdmGoalSetBadge?: SdmGoalSetBadge[] | null; 
  } 
